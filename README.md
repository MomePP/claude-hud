...
> **Latest release: [v0.9.0](https://github.com/MomePP/claude-hud/releases/tag/v0.9.0).** `/plugin install` always pulls the newest version from the marketplace — no version pinning needed.
